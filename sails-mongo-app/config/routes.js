...
module.exports.routes = {
  ...
  "GET /view-company": { action: "view-company" },
  ...
  "GET /view-payment": { action: "entrance/view-payment" },
  "GET /employee": { action: "view-employee" },
  'GET /institute': { action: 'view-institute' },
  'GET /subscription': { action: 'view-subscription' },
  ...
  'POST /api/v1/institute': { action: 'institute' },

  "POST /api/v1/company": { action: "company" },
  "POST /api/v1/employee": { action: "employee" },
  'POST /api/v1/subscription': { action: 'subscription' },
};
