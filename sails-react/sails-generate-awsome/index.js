...
/**
 * @techno12/sails-generate-awsome
 *
 * Usage:
 * `sails generate awsome`
 *
 * @description Generates a awsome.
...
module.exports = {
  ...
  before: function (scope, done) {
    ...
    // //
    // // e.g. if someone runs:
    // // $ sails generate awsome user find create update
    // // then `scope.args` would be `['user', 'find', 'create', 'update']`
    // if (_.isUndefined(scope.args[0])) {
    //   return done(new Error('Please provide a name for this awsome.'));
    // }
